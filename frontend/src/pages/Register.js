...
const Register = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      navigate('/login', { state: { mensagem: response.data.message } });
    } catch (error) {
        ...
        >
          ...
          <form onSubmit={handleRegister} style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
            ...
            <div style={{ textAlign: 'left' }}>
              ...
              <input
                type="password" placeholder="Crie uma senha forte" value={senha}
            ...
            <div style={{ textAlign: 'left' }}>
              ...
              <input
                type="password" placeholder="Repita a senha" value={confirmarSenha}
